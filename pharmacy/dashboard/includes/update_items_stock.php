								...
								if ($res == TRUE) {
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="row">
                                               <div class="col-md-6">
                                                <label for="example-email" class="col-md-4">Item Name</label>
                                                <input type="text" name="title"
                                                class="form-control form-control-line"  value="<?php echo $item_name?>" name="example-email"
                                                id="example-email">
                                                </div>
                                                <div class="col-md-6">
                                                <label for="quanitity" class="col-md-4">Quanitity</label>
							...
							?>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <button class="btn btn-success btn-block" type="submit" name="submit" >Update Quanitity</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- title -->
