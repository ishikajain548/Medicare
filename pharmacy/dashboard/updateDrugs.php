                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                <label for="example-email" class="col-md-4">Total Quanitity</label>
                                                ...
                                                <div class="col-md-6">
                                                <label for="example-email" class="col-md-4">Expiry Date</label>
                                                <input type="text" name="expiryDate" value="<?php echo $expiry_date?>"
                                                class="form-control form-control-line" 
                                                id="price">
												
                                                </div>
                                                <div class="col-md-6">
                                                <label for="example-email" class="col-md-4">Price</label>
